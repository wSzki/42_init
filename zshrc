...
alias lok="ft_lock"
alias lock="ft_lock"
alias test="cd ~/containers/inc/containers_test/ && ./do.sh map"

function try {
	cd ~/containers/inc/containers_test/srcs/map
	ls
	c++ --std=c++98 -Wall -Wextra -Werror $1.cpp -I ../../../
}
...
alias web="docker run -it browsh/browsh "
...
export CPATH=:/mnt/nfs/homes/wszurkow
export CPATH=:/home/wsz:/mnt/nfs/homes/wszurkow/containers/inc
